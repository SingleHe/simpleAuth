...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/static/jquery-treetable/stylesheets/jquery.treetable.css">
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/static/jquery-treetable/stylesheets/jquery.treetable.theme.default.css">
    <style type="text/css">
        #table th , #table td{
            font-size: 14px;
            padding:8px;
...
<body>
                    ...
                    <td>
                        <shiro:hasPermission name="resource:create">
                            <c:if test="${resource.type ne 'button'}">
                                <a href="${pageContext.request.contextPath}/resource/${resource.id}/appendChild">
                                    添加子节点
                                </a>
                            </c:if>
                        </shiro:hasPermission>
    ...
    <script src="${pageContext.request.contextPath}/WEB-INF/static/jquery-treetable/javascripts/src/jquery.treetable.js"></script>
    <script type="text/javascript">
        $(function () {
            $("#table").treetable({extandable:true}).treetable("expandNode",1);
