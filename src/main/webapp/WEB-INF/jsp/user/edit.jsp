...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/WEB-INF/static/JQuery zTree v3.5.15/css/zTreeStyle/zTreeStyle.css">
    <style type="text/css">
        ul.ztree{
            margin-top: 10px;
    ...
    <form:form method="post" commandName="user">
        ...
        <div class="form-group">
            ...
            <form:select path="roleIds" items="${roleList}"
                         ...
                         multiple="true"/>（按住Shift多选）
        </div>
        <form:button>${op}</form:button>
    </form:form>
    <div id="menuContent" class="menuContent" style="display: none;position:absolute;">
        <ul id="tree" class="ztree" style="margin-top:0px;width:160px;">
